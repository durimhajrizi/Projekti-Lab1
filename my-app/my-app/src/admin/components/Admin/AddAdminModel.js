...
import '../../assets/css/addadminmodel.css';

export class AddAdminModel extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
        ...
        fetch('http://localhost:39990/api/admin/createAdmin', {
            method: 'POST',
            headers: {
                        ...
                        <Row>
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId='firstname'>
                                        <Button variant='primary' type='submit' onClick={this.props.onHide}>Add Admin</Button>
                                    </Form.Group>
                                </Form>
                            </Col>
                        </Row>
